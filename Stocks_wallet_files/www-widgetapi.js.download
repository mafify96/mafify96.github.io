...
function pa(a,b){a.j={W:b,ra:!0};a.h=a.l||a.u}
...
function ua(a){for(;a.h.h;)try{var b=a.i(a.h);if(b)return a.h.o=!1,{value:b.value,done:!1}}catch(c){a.h.m=void 0,pa(a.h,c)}a.h.o=!1;if(a.h.j){b=a.h.j;a.h.j=null;if(b.ra)throw b.W;return{value:b["return"],done:!0}}return{value:void 0,done:!0}}
...
function wc(a){var b=tc();b.update(a);return b.ja().toLowerCase()}
...
Se.prototype.l=function(a){if(a.origin==R(this,"host")||a.origin==R(this,"host").replace(/^http:/,"https:")){try{var b=JSON.parse(a.data)}catch(c){return}this.j=!0;this.h||0!=a.origin.indexOf("https:")||(this.h=!0);if(a=Ue[b.id])a.u=!0,a.u&&(H(a.s,a.T,a),a.s.length=0),a.ba(b)}};
...
function Qf(a,b){if("log_event"===a.endpoint){var c="";a.B&&(Pf[a.B.token]=Rf(a.B),c=a.B.token);var d=Of.get(c)||[];Of.set(c,d);d.push(a.payload);b&&(Jf=new b);c=We("web_logging_max_batch")||100;var e=T();d.length>=c?Sf({writeThenSend:!0}):10<=e-Mf&&(Tf(),Mf=e)}}
function Uf(a,b){if("log_event"===a.endpoint){var c="";a.B&&(Pf[a.B.token]=Rf(a.B),c=a.B.token);var d=new Map;d.set(c,[a.payload]);b&&(Jf=new b);return new O(function(e){Jf&&Jf.isReady()?Vf(d,e,{bypassNetworkless:!0}):e()})}}
function Sf(a){a=void 0===a?{}:a;return new O(function(b){window.clearTimeout(Kf);window.clearTimeout(Lf);Lf=0;Jf&&Jf.isReady()?(Vf(Of,b,a),Of.clear()):(Tf(),b())})}
function Tf(){S("web_gel_timeout_cap")&&!Lf&&(Lf=Ae(Sf,6E4));window.clearTimeout(Kf);var a=Q("LOGGING_BATCH_TIMEOUT",We("web_gel_debounce_ms",1E4));S("shorten_initial_gel_batch_timeout")&&Nf&&(a=Ff);Kf=Ae(function(){Sf({writeThenSend:!0})},a)}
function Vf(a,b,c){var d=Jf;c=void 0===c?{}:c;var e=Math.round(T()),f=a.size;a=u(a);for(var g=a.next();!g.done;g=a.next()){var h=u(g.value);g=h.next().value;var k=h.next().value;h=Xa({context:Wf(d.h||Xf())});h.events=k;(k=Pf[g])&&Yf(h,g,k);delete Pf[g];Zf(h,e);S("send_beacon_before_gel")&&window.navigator&&window.navigator.sendBeacon&&!c.writeThenSend&&xf();$f(d,"log_event",h,{retry:!0,onSuccess:function(){f--;f||b();If=Math.round(T()-e)},
...
function Wf(a){var b={client:{hl:a.na,gl:a.ma,clientName:a.la,clientVersion:a.innertubeContextClientVersion,configInfo:a.ka}},c=window.devicePixelRatio;c&&1!=c&&(b.client.screenDensityFloat=String(c));c=Q("EXPERIMENTS_TOKEN","");""!==c&&(b.client.experimentsToken=c);c=[];var d=Q("EXPERIMENTS_FORCED_FLAGS",{});for(e in d)c.push({key:e,value:String(d[e])});var e=Q("EXPERIMENT_FLAGS",{});for(var f in e)f.startsWith("force_")&&void 0===d[f]&&c.push({key:f,value:String(e[f])});0<c.length&&(b.request={internalExperimentFlags:c});
...
;var nh;function oh(a,b){b=void 0===b?{}:b;dh().then(function(){nh||(nh=new lh({sa:!0}));nh.i.l!==hh()&&re(new U("NetworkStatusManager isOnline does not match window status"));of(a,b)})}
...
timeout:d.timeout,withCredentials:!0},g="";(e=a.h.oa)&&(g=e);var h=a.h.qa||!1,k=dg(h,g,d);Object.assign(f.headers,k);f.headers.Authorization&&!g&&(f.headers["x-origin"]=window.location.origin);e="/youtubei/"+a.h.innertubeApiVersion+"/"+b;var l={alt:"json"};a.h.pa&&f.headers.Authorization||(l.key=a.h.innertubeApiKey);var m=Je(""+g+e,l||{},!0);dh().then(function(n){if(d.retry&&S("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=g){if(S("networkless_gel")&&!n||!S("networkless_gel"))var p=ig(b,
c,k,h);if(p){var q=f.onSuccess,v=f.onFetchSuccess;f.onSuccess=function(w,y){jg(p);q(w,y)};
c.onFetchSuccess=function(w,y){jg(p);v(w,y)}}}try{S("use_fetch_for_op_xhr")?lf(m,f):S("networkless_gel")&&d.retry&&!d.Z.bypassNetworkless?(f.method="POST",!d.Z.writeThenSend&&S("nwl_send_fast_on_unload")?ph(m,f):oh(m,f)):(f.method="POST",f.postParams||(f.postParams={}),of(m,f))}catch(w){if("InvalidAccessError"==w.name)p&&(jg(p),p=0),re(Error("An extension is blocking network request."));
else throw w;}p&&Ze(function(){kg(a)},0,5E3)})}
;function rh(a,b){var c=void 0===c?{}:c;var d=qh;Q("ytLoggingEventsDefaultDisabled",!1)&&qh==qh&&(d=null);c=void 0===c?{}:c;var e={};e.eventTimeMs=Math.round(c.timestamp||T());e[a]=b;var f=C("_lact",window);f=null==f?-1:Math.max(Date.now()-f,0);e.context={lastActivityMs:String(c.timestamp||!isFinite(f)?-1:f)};if(S("log_sequence_info_on_gel_web")&&c.ca){f=e.context;var g=c.ca;ag[g]=g in ag?ag[g]+1:0;f.sequence={index:ag[g],groupKey:g};c.Ma&&delete ag[c.ca]}(c.Sa?Uf:Qf)({endpoint:"log_event",payload:e,
B:c.B},d)}
...
r.aa=function(){this.h&&this.h.contentWindow?this.T({event:"listening"}):window.clearInterval(this.j)};
